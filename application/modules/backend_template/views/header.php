...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Ayo</b>TOUR</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo ucwords($this->session->userdata('first_name')) ?></span>
            </a>
            <ul class="dropdown-menu">
              <li style="padding: 5px;"><a href="<?php echo site_url('at-admin/user/change_password') ?>" class="fa fa-lock"> Change Password</a></li>
              <li style="padding: 5px;"><a href="<?php echo site_url('auth/logout') ?>" class="fa fa-sign-out"> Logout</a></li>
            </ul>
          </li>
